...
plt.savefig('..\\EvaluationResults\\ModelsConfusionMatrix', dpi=300)
plt.show()
...
plt.savefig("..\\EvaluationResults\\ClassificationReport.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("..\\EvaluationResults\\MisclassifiedSamples.png", dpi=300)
plt.show()
# endregion
